...
<div align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=20&pause=1000&color=9EB8FB&center=true&vCenter=true&width=600&lines=Analytics+Engineering+%7C+AI+%7C+LLM+%E2%9A%A1;Always+learning%2C+always+growing+%E2%9C%A8;Playdata+CAMP+(Seocho)+SKN+30" alt="Typing SVG" />
  </a>
</div>
...
<div align="center">
  <p><b>안녕하세요, 김도훈입니다.</b></p>
  <p>➡️ 다양한 경험과 데이터 분석 역량을 바탕으로 문제의 본질을 정의하고, 데이터 관점에서 최적의 솔루션을 도출합니다.</p>
  
  <br>

  <p><b>🎯 Core Value</b></p>
  <p><i>"데이터 수집부터 LLM 서빙까지, AI 파이프라인 전체를 전담해 제품 출시 주기를 단축합니다."</i></p>

  <br>

  <p><b>1️⃣ End-to-End AI 파이프라인 구축</b><br>
  웹 크롤링 및 DB 설계부터 ML/DL 모델링, LLM 파인튜닝, 프롬프트 엔지니어링, 멀티모달 모델 구축까지 전 과정을 직접 구현합니다.</p>

  <p><b>2️⃣ 안정적인 백엔드 및 인프라 서빙</b><br>
  FastAPI, Linux, Cloud 환경을 활용해 개발된 모델을 고가용성 API 서버로 구축하고 서비스 인프라에 배포합니다.</p>

  <p><b>3️⃣ SW 공학 기반 상용 제품화</b><br>
  소프트웨어 엔지니어링 원칙과 UI 구현 역량을 바탕으로, 단순 실험실 모델을 실제 운용 가능한 상용 제품으로 완성합니다.</p>

  <p><b>4️⃣ 커뮤니케이션 병목 제로화</b><br>
  기획·모델링·배포 전 단계를 이해하여 직군 간 병목을 제거하고, 제품 개발 주기(Lead Time)와 커뮤니케이션 비용을 최소화합니다.</p>
</div>
...
<div align="center">
  ...
  <!-- Docker Desktop --> <img src="https://img.shields.io/badge/Docker%20Desktop-2496ED?style=for-the-badge&logo=docker&logoColor=white"/>
</div>
...
<div align="center">
  <table width="100%">
    <thead>
      <tr>
        <th width="30%" align="left">프로젝트 이름</th>
        <th width="70%" align="left">설명</th>
      </tr>
    </thead>
    <tbody>
      <!-- 프로젝트 1 -->
      <tr>
        <td align="left">🚗 <a href="https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN30-1st-4Team">프로젝트1</a></td>
        <td align="left">전기차 충전 인프라 SOS 대시보드</td>
      </tr>
      <tr>
        <td colspan="2" align="left"><b>Tech Stack:</b> Python, MySQL, Streamlit, Plotly, Pandas, NumPy, Selenium</td>
      </tr>
      <!-- 프로젝트 2 -->
      <tr>
        <td align="left">📺 <a href="https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN30-2nd-1Team">프로젝트2</a></td>
        <td align="left">YouTube 크리에이터 분석을 통한 광고효율 및 지속가능성 추천 시스템</td>
      </tr>
      <tr>
        <td colspan="2" align="left"><b>Tech Stack:</b> Python, MySQL, Plotly, Scikit-learn, Docker, Pandas, NumPy, Streamlit</td>
      </tr>
      <!-- 프로젝트 3 -->
      <tr>
        <td align="left">🪴 <a href="https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN30-3rd-3Team">프로젝트3</a></td>
        <td align="left">멀티모달 RAG 기반 식물 주치의 AI</td>
      </tr>
      <tr>
