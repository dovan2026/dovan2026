...
<div align="center">
  ...
  <p><b>데이터 수집부터 LLM 서비스 배포까지 파이프라인 전체를 전담하여 엔지니어링 비용을 절감합니다.</b></p>
  <p><b>AI/ML 파이프라인 구축:</b> 웹 크롤링 및 DB 설계부터 머신러닝/딥러닝, 프롬프트 엔지니어링, LLM 파인튜닝, 멀티모달 모델 구축까지 전 과정을 구현합니다.</p>
  <p><b>백엔드 및 인프라 전개:</b> FastAPI, Linux, 클라우드 환경을 활용해 모델을 안정적인 API 서버로 구축하고 인프라에 배포합니다.</p>
  <p><b>SW 공학 기반 개발:</b> 소프트웨어 공학 원칙 준수 및 화면 구현 능력을 바탕으로 실제 운용 가능한 제품으로 완성합니다.</p>
  <p><b>기획·모델링·배포 간 커뮤니케이션 병목을 제거하여 제품 개발 주기(Lead Time)를 최소화합니다.</b></p>
</div>
